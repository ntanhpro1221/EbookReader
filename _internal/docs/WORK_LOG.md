...
| Thay `người gọi X` bằng UNKNOWN để chuỗi sửa tìm người nói thật (21-09) | **Sai, và mã nguồn nói ngay.** Tôi tưởng gán UNKNOWN thì `_repair_same_paragraph_speakers` / `_repair_continued_dialogue_speakers` sẽ điền người nói thật, và câu hỏi "chín ăn hai" ở trên tự tan. Nhưng đoạn được sửa CHÍNH LÀ mốc neo của đoạn văn: `_repair_same_paragraph_speakers` chỉ nhận neo mang `EXPLICIT_ATTRIBUTION_NOTE` hoặc `ADDRESSEE_REPAIR_NOTE` rồi lan người nói ấy ra các câu thoại còn lại cùng đoạn. `người gọi X` không phải giải pháp tạm - nó là một **danh tính nhất quán trong đoạn**, nên có giọng nhất quán; gán UNKNOWN là phá cái neo và đổi 9 câu sai thành 9 câu vô danh RỜI RẠC. Câu hỏi vẫn thuộc về tai chủ sách. Đóng bằng đọc mã, 10 phút, không tốn phép đo |
