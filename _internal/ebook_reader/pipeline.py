...
class BookPipeline:
    ...
    def _verify_chapter_perceptual_audio(self, chapter: Any) -> list[dict[str, Any]]:
        ...
        accepted_takes = self.db.ruled_segment_takes()
    ...
    def _high_quality_blocking_segment_warnings(
        ...
        # `ruled_`, không phải `accepted_`: cổng hỏi "đã có ai phán xử bản thu này chưa",
    ...
    def _grant_machine_acceptances(self, chapter: Any) -> list[dict[str, Any]]:
